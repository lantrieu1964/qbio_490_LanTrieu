...
var_name <- "Lan"
var_age <- 17
var_birthday <- 11/06/2005
var_three_fav_colors <- "green,red,blue"

print(var_name)
print(var_age)
print(var_birthday)
print(var_three_fav_colors)

typeof(var_name) - character
typeof(var_age) - double
typeof(var_birthday) - double
typeof(var_three_fav_colors) - character
```
