...
cleaned_clinical$metastasis_status <- ifelse(cleaned_clinical$definition == "Metastatic", "Yes", 
                                      ifelse(cleaned_clinical$definition == "Primary Solid Tumor", "No", NA))
cleaned_clinical <- cleaned_clinical[!is.na(cleaned_clinical$metastasis_status), ]
...
cleaned_clinical <- cleaned_clinical[!is.na(cleaned_clinical$survival_time),]
...
fit_object <- survfit(survival_object ~ metastasis_status, 
                      data = cleaned_clinical)
